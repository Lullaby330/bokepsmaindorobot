...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6472922432:AAF_BpuOd90Uief1CkdQYxej7671rqCMML0")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001248384666"))
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002170568544"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS",  "5084234580 6605337634").split()):
        ADMINS.append(int(x))
except ValueError:
